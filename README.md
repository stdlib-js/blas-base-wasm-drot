...
```javascript
drot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-drot@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-wasm-drot/tags). For example,

```javascript
drot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-drot@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var drot = require( 'path/to/vendor/umd/blas-base-wasm-drot/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-drot@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-base-wasm-drot.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-base-wasm-drot

[test-image]: https://github.com/stdlib-js/blas-base-wasm-drot/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-wasm-drot/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-base-wasm-drot/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-base-wasm-drot?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-wasm-drot.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-wasm-drot/main
...
[branches-url]: https://github.com/stdlib-js/blas-base-wasm-drot/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-base-wasm-drot/main/LICENSE
