...
var j=require('@stdlib/assert-is-wasm-memory/dist'),E=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),z=require('@stdlib/utils-inherit/dist'),M=require('@stdlib/wasm-module-wrapper/dist'),D=require('@stdlib/error-tools-fmtprodmsg/dist'),k=m();function d(e){if(!(this instanceof d))return new d(e);if(!j(e))throw new TypeError(D('26fH0',e));return M.call(this,k,e,{env:{memory:e}}),this}z(d,M);E(d.prototype,"main",function(r,n,i,a,t,s,u){return this._instance.exports.c_drot(r,n,i,a,t,s,u),a});E(d.prototype,"ndarray",function(r,n,i,a,t,s,u,l,q){return this._instance.exports.c_drot_ndarray(r,n,i,a,t,s,u,l,q),t});_.exports=d
